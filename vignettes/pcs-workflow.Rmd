...
Since 2007, Peter Sagan has finished `r races_finished` races in total. Among those `r races_finished` races, he has placed in the top ten `r top_10` times, and has an incredible `r wins` wins to his name, giving him a historical winning percentage of `r round(wins/races_finished, 1)*100`%.
